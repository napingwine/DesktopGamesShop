...
interface IBurgerMenu {
  ...
  textForBurger?: string
}

const BurgerMenu: FC<IBurgerMenu> = ({ burgerMenuOpen, textForBurger }) => {
  useEffect(() => {
    document.querySelector('.burgerSVG').classList.toggle('opened')
  ...
  return (
    <div className="burger">
      <div className="burger-icon">
        <span className="burger-icon__menu-btn" aria-label="Main Menu" aria-expanded="false" >
          <svg width="25" height="25" viewBox="0 0 100 100" className='burgerSVG'>
